...
$stm2 = DebsModel::get_teacher_documentdetails_by_id($public_id);
?>
<!DOCTYPE html>
<html lang="en">
      ...
      <section class="wrapper">
        <div class="row">
          <div class="col-lg-12 main-chart">
              ...
              <h3>Ministry Of Education Documents</h3>
            </div>
              ...
              <table cellpadding="0" cellspacing="0" border="0" class="display table table-bordered" id="hidden-table-info">
                ...
                <tbody>
                  ...
                  <tr >
                    ...
                    <td>
                        <button onclick="redirectWithID2('<?php echo $public_id2;?>')" class="btn btn-success btn-xs btn_school_profile"><i class="fa fa-eye"></i></button>
              ...
              <div class=" form">
                  ...
                  <div class="form-group ">
                    ...
                    <div class="col-lg-offset-1 col-lg-10">
                        <button type="submit" name="btn_upload_user_doc_t" class="btn btn-theme start">
...
//     });
      ...
      function redirectWithID2(id){
        
        window.open("/RDMS/view/teacher/view_1.php?id="+id, "_blank");
    }
    function redirectWithID(id){
        
        window.open("/RDMS/view/teacher/view.php?id="+id, "_blank");
    }
      function deletWithID(id){
         window.location.href = "/RDMS/view/teacher/deletdoc.php?id="+id;
