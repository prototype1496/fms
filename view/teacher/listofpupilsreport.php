 ...
 <!-- ========== Left Sidebar Start ========== -->
            ...
            <div class="content-page">
                ...
                <ul class="breadcrumb">
                    ...
                    <li><a href="/RDMS/view/teacher/index.php">Home</a></li>   
                                                    ...
                                                    <table>
                                                        <tr>
                                                            ...
                                                            <div class="input-group-btn ">
                                                                ...
                                                                <button style="background-color: blue;" id="btn_search_ttms_data" name="btn_pupil_data_t" class="btn btn-primary ">Search</button>
