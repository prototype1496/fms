          ...
          <div class="col-lg-12">
            <div class="row content-panel">
              ...
              <div class="col-md-4 profile-text">
                ...
                <h6>Name</h6>
                <p>Education is the to development therefor uphold the code of conduct</p>
                <br>
              ...
              <table cellpadding="0" cellspacing="0" border="0" class="display table table-bordered" id="hidden-table-info">
                ...
                <tbody>
                  ...
                  <tr >
                    ...
                    <td>
                        <button onclick="redirectWithID('<?php echo $row['TeacherDetailsPublicID'];?>')" class="btn btn-success btn-xs"><i class="fa fa-eye"></i></button>
