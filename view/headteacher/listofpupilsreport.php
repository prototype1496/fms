...
if(isset($_GET['grade'])){
    ...
    $stm = SuperModel::get_list_of_students_by_grade($grade); 

}else {
    
    $stm = SuperModel::get_list_of_students();
}
...
<html lang="en">
    <head>
        <meta charset="utf-8" />
        <title>Teacher Worked Time Report</title>
 ...
 <!-- ========== Left Sidebar Start ========== -->
            ...
            <div class="content-page">
                ...
                <ul class="breadcrumb">
                    ...
                    <li><a href="/RDMS/view/headteacher/index.php">Home</a></li>   
					<li><a href="#">Report</a></li> 					
                    <li class="active">List Of Register Pupils</li>
                </ul>
                <!-- END BREADCRUMB -->  
                                                    ...
                                                    <table>
                                                        <tr>
                                                            ...
                                                            <div class="input-group-btn ">
                                                                ...
                                                                <button style="background-color: blue;" id="btn_search_ttms_data" name="btn_pupil_data" class="btn btn-primary ">Search</button>
...
<div class="row">
              <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                  <div class="x_title">
                    <h2>List Of Register Pupils Report</h2>
